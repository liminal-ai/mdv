...
**ACs:** AC-1.1, AC-1.2, AC-1.3, AC-1.4, AC-1.5, AC-2.1 (smoke test — shell renders), AC-10.1 (initial helpers), AC-10.2

**TCs:** TC-1.1a–d, TC-1.2a–b, TC-1.3a–c, TC-1.4a–c, TC-1.5a, TC-2.1a–b, TC-10.1a–c (stub), TC-10.2a
...
**Test Count:** 3 tests (1 smoke + TC-2.1a shell elements + TC-2.1b empty state)

### Chunk 1: Workspace Browsing and File Opening

**Scope:** E2E tests for workspace browsing, file tree population, file opening. Validates the entry point flow.

**ACs:** AC-2.2, AC-2.3

**TCs:** TC-2.2a–c, TC-2.3a–b
...
**Test Count:** 5 tests (TC-2.2a, TC-2.2b, TC-2.2c, TC-2.3a, TC-2.3b)
**Running Total:** 8 tests (3 Chunk 0 + 5 navigation)
